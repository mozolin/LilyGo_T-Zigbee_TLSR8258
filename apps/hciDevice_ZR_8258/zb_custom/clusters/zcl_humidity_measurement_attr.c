/********************************************************************************************************
 * @file	zcl_humidity_measurement_attr.c
 *******************************************************************************************************/
#if 0
#include "tl_common.h"
...
const zclAttrInfo_t humidity_measure_attrTbl[] =
{
...
const u8 zcl_humidity_measure_attrNum = ( sizeof(humidity_measure_attrTbl) / sizeof(zclAttrInfo_t) );
